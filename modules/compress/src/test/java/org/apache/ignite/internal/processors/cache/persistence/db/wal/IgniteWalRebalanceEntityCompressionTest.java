 ...
 */
public class IgniteWalRebalanceEntityCompressionTest extends GridCommonAbstractTest {
  /** Cache name. */
  ...
  @Override protected IgniteConfiguration getConfiguration(String gridName) throws Exception {
    ...
    CompressionConfiguration compressionCfg = new CompressionConfiguration();
    compressionCfg.setEnabled(true);
    compressionCfg.setCompressionLevel(17);

    CacheConfiguration<Object, Object> ccfg = new CacheConfiguration<>(CACHE_NAME)
            .setCompressionConfiguration(compressionCfg)
    ...
    DataStorageConfiguration dbCfg = new DataStorageConfiguration()
            .setWalPageCompression(DiskPageCompression.LZ4)
  ...
  @Override protected void afterTest() throws Exception {
    ...
    boolean walRebalanceInvoked = !WalRebalanceCheckingCommunicationSpi.allRebalances()
            .isEmpty();
  ...
  public void testSimple() throws Exception {
    ...
    public void testSwitchHistoricalRebalanceToFullAndClientJoin() throws Exception {
        testSwitchHistoricalRebalanceToFull(
                IgniteWalRebalanceEntityCompressionTest::injectFailingIOFactory,
            () -> {
    ...
    public void testSwitchHistoricalRebalanceToFullDueToFailOnCreatingWalIterator() throws Exception {
        testSwitchHistoricalRebalanceToFull(IgniteWalRebalanceEntityCompressionTest::injectFailingIOFactory, () -> true);
    }
