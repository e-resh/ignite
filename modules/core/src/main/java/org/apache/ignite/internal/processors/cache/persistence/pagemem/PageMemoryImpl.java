...
public class PageMemoryImpl implements PageMemoryEx {
    ...
    private class Segment extends ReentrantReadWriteLock {
        ...
        private boolean isStoreMetadataPage(PageIO io) {
            return io != null && (io instanceof PagePartitionMetaIO
        ...
        private boolean isBPlusLeafIOPage(PageIO io) {
            return io != null && io instanceof BPlusLeafIO;
        }
        ...
        private boolean isBPlusInnerIOPage(PageIO io) {
            return io != null && io instanceof BPlusInnerIO;
        }
        ...
        private boolean isListNodeIOPage(PageIO io) {
            return io != null && io instanceof PagesListNodeIO;
        }
